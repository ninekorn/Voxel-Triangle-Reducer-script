...
I built my own version of a face reducer without changing the LOD (level of detail). The tris are reduced more than 10 fold and the verts reduced by approx 5 times. It's pretty much dependant on how bumpy the terrain is.
